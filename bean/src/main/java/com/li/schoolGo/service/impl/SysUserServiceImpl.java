...
public class SysUserServiceImpl implements SysUserService {
    ...
    public boolean updateRedisDate(String userId) {
    ...
    @Override
    public Boolean updateUserPwd(String id, String password) {
        SysUser sysUser = new SysUser();
        sysUser.setId(id);
    ...
    @Override
    public Boolean getSysUser(String id, String oldPassword) {
        SysUser user = new SysUser();
        user.setId(id);
        String realPwd = DigestUtils.md5DigestAsHex(oldPassword.getBytes());
